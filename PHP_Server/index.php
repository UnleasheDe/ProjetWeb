...
<head>
    ...
    <link href="assets/shop-homepage.css?1155455611641515119" rel="stylesheet">
...
<body>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12">
    <div class="text-center">
              <h2 class="h2-responsive font-weight-bold text-center my-4" style="margin-left: 0px">Nos meilleurs ventes</h2>
        </div>
        </div>
    ...
    <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
      ...
      <div id="carourou" class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
            <h5>Notre deuxième meilleure vente !</h5>
            <p><?= $product->Nom; ?></p>
          </div>
          <?php } }?>
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
            <h5>Notre troisieme meilleure vente !</h5>
            <p><?= $product->Nom; ?></p>
          </div>
          <?php } }?>
        </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
    <div class="text-center">
              <h2 class="h2-responsive font-weight-bold text-center my-4" style="margin-left: 0px">Évènements du mois</h2>
        </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 mb-4">
            <div class="card h-100">
              ...
              <p class="addbutton">
                <a id="grosbouton2" class="btn" href="evenements.php" role="button">Voir les evenements</a>
              </p>
            </div>
          </div>
        <?php } }?>          
